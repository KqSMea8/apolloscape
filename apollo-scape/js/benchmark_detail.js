    ...
    var app = new Vue({
        ...
        methods: {
            getData: function () {
                ...
                $.tool.ajax('/server/assess/benchmark/method_detail', {method_id: param.method_id}, function (res) {
                    self.overview = res.data;
                    for (var key in res.data.miou_class) {
                        self.miou_class.push(key);
                    }
                    res.data.miou_class.Miou = res.data.miou_score;
                    self.tableData = [res.data.miou_class];
                });
            },
            download: function () {
                window.location = '';
