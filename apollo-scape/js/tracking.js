...
function getArr() {
    var arrEn = {
        'banner': [
            {
                'title': '3D Lidar object tracking',
                'brief': [
                    'The large-scale dataset for urban traffic includes sequential RGB images and 3D Lidar point cloud with high-quality annotations. It can be used for 3D detection and tracking tasks.'
                ]
                // ,
                // 'operation': {
        ...
        'menu': [
            ...
            {
                'word': '6· Metric formula',
                'id': 'to_metric',
                'classes': 'menu-1 to_btn'
            },
            {
                'word': '7· Rules of ranking',
                'id': 'to_rules',
                'classes': 'menu-1 to_btn'
            },
            {
                'word': '8· Format of submission file',
                'id': 'to_submission',
                'classes': 'menu-1 to_btn'
            },
            {
...
function download(id) {
    var isAgree = $('.agree_btn').attr('value');
    $.get(
