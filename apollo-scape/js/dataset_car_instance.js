...
function get_arr() {
    var arrEn = {
        'banner': [
            {
                'title': '3D Car Instance',
                'brief': [
                    'This large-scale dataset contains a diverse set of stereo video sequences recorded in street scenes from different cities,',
                    'with high quality annotations of 5000+ frames.'
                ]
                // ,
                // 'operation': {
        ...
        'menu': [
            ...
            {
                'word': '3· Dataset Download',
                'id': 'to_dataset',
                'classes': 'menu-1 to_btn'
            },
            {
                'word': '4· Dataset Structure',
                'id': 'to_structure',
                'classes': 'menu-1 to_btn'
            },
            {
            ...
            {
                'word': '7· Metric formula',
                'id': 'to_metric',
                'classes': 'menu-1 to_btn'
            },
            {
                'word': '8· Rules of ranking',
                'id': 'to_rules',
                'classes': 'menu-1 to_btn'
            },
            {
                'word': '9· Submission of data format',
                'id': 'to_submission',
                'classes': 'menu-1 to_btn'
            },
            {
